...
<body>
 ...
 <h1 style="text-align: center;">Attendance Courses Available</h1>
 <table class="table">
  ...
  while ($row = mysqli_fetch_assoc ($result)) {
    echo'<tbody>
      <tr>
      <th>'.$row['attend_id']. '</th>
      <td> <a href="attendingCoursesShow.php?attendnumber='.$row['attend_id'].'">'.$row['attend_name'].'</a> </td>
      <td>'.$row['attend_hrs']. '</td>
      <td>'.$row['attend_cost'].'$  </td>
    </tr>
    </tbody>
    ';
