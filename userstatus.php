...
<body>
 ...
 <?php if (isset ($_SESSION['userid'])){ ?> 
  <h1 style="text-align: center;">Set admin users</h1>
  <BR> <BR>
  ...
  $sql= "SELECT id, First_name, is_admin FROM users WHERE NOT is_admin=2 AND NOT id='$userid';";
  ...
  while ($row = mysqli_fetch_assoc ($result)) {
    ...
    <tbody>
      ...
      <td> <form action="userstatus.controller.php" method="post">
           
           <input type="checkbox" name="checkbox[<?php echo $row['id'];?>]" onchange="this.form.submit()" 
           ...
           >
           <input type="hidden" name="checkbox_mark[<?php echo $row['id'];?>]" value="1">
            </td>  
<?php
 } 
 ?>
