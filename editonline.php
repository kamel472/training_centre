...
<body>
 ...
 <div class="container">
  ...
  $sql= "SELECT online_name, online_hrs, online_cost, online_tutor, online_desc, online_lastupdated,video_name
   FROM onlinelist WHERE online_id='$courseid';"; 
  $result = mysqli_query ($conn , $sql);

  while ($row = mysqli_fetch_assoc ($result)) {
    ?>
    <form action="editonline.controller.php" id="contactForm" method="POST" enctype='multipart/form-data'>
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              <label>Program Name</label>
              <input type="text" class="form-control" placeholder="Program Name" name="name" required value="<?php echo $row['online_name'] ?>">
          ...
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              <label>Tutor</label>
              <input type="text" class="form-control" placeholder="Tutor" name="tutor" required value="<?php echo $row['online_tutor'] ?>">
          ...
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              ...
              <input type="text" class="form-control" placeholder="Total hours " name="hrs" required value="<?php echo $row['online_hrs'] ?>">
          ...
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              <label>Cost</label>
              <input type="text" class="form-control" placeholder="Cost" name="cost" required value="<?php echo $row['online_cost'] ?>">
              <p class="help-block text-danger"></p>
            </div>
          </div>
          <div class="control-group">
            <div class="form-group col-xs-12 floating-label-form-group controls">
              ...
              <input type="text" class="form-control" placeholder="Course Description" name="desc" required  value="<?php echo $row['online_desc'] ?>">
              <p class="help-block text-danger"></p>
            </div>
          </div>
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              ...
              <input type="date/time" class="form-control" placeholder="Last updated" name="lastupdated" required value="<?php echo $row['online_lastupdated'] ?>">
              <p class="help-block text-danger"></p>
            </div>
          </div>
          <div class="control-group">
