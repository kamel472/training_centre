...
elseif (isset ($_GET['create'])){
  echo '<div class="alert alert-success" role="alert">New course data inserted successfully </div> ';
}
  
  if (isset($_GET['submit'])){

    ?>
    <form action="createattend.controller.php" id="contactForm" method="POST" enctype='multipart/form-data'>
          ...
          <div class="control-group">
            <div class="form-group col-xs-12 floating-label-form-group controls">
              ...
              <input type="text" class="form-control" placeholder="Course Place" name="place" required >
              <p class="help-block text-danger"></p>
            </div>
          </div>
          <div class="control-group">
...
<img class="d-block w-100" src="img/placeholdr.png " alt="First slide">
</div>
