...
<body>
 ...
 <?php if (isset ($_SESSION['userid'])){ ?> 
  <h1 style="text-align: center;">Attendance Courses</h1>
  ...
  <br>
  <form action= "createattend.php" method="GET">
  ...
  $sql= "SELECT attend_id, attend_name FROM attendlist;";
  ...
  while ($row = mysqli_fetch_assoc ($result)) {
    ...
    <tbody>
      <tr>
      <th><?php echo $row['attend_id'] ?> </th>
      <td><?php echo$row['attend_name']?> </td>
      <td> 
      <form action= "editattend.php" method="GET">
      <input type="hidden" name="courseid" value= <?php echo $row['attend_id']?> >
      <button type="submit" class="btn btn-primary btn-sm" name="submit-edit" >Edit</button>  
      </form>
      </td>
      <form action= "deleteattend.controller.php" method="GET" >
      <input type="hidden" name="courseid" value= <?php echo $row['attend_id']?>>
      <td><button type="submit" class="btn btn-danger btn-sm deletebtn" name="submit-delete" 
