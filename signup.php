...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <p style="text-align: center; font-size: 30px; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Fill the following data to Sign up</p>
        <p style="text-align: center;">Already a member? <a href="signin.php">Sign in</a></p>
        ...
        <form action="signup.controllers.php" id="contactForm" method="POST">
        <!-- add required to all fields that not nullable in teh database -->
          ...
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              <label>Age</label>
              <input type="number" class="form-control" placeholder="Age" name="age" required value=
              <?php
