...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <p style="text-align: center; font-size: 30px; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Please sign in</p>
        <p style="text-align: center;">Not a member?  <a href="signup.php">Sign up</a></p>
        ...
        break;
        case $_GET['error']=="wrongcredintails";
        echo ' <div class="alert alert-danger" role="alert"> You entred worng credintails </div>';
        break;
}
        }
        ...
        <form action="signin.controllers.php" method="POST">
          ...
          <div class="form-group">
            <button type="submit" class="btn btn-danger" name="forgotPassword">Forgot Password?</button>
          </div>
